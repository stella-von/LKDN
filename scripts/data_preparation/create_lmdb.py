...
def create_lmdb_for_df2k():
    ...
    """
    # HR images
    folder_path = 'datasets/DF2K/DF2K_train_HR_sub'
    lmdb_path = 'datasets/DF2K/DF2K_train_HR_sub.lmdb'
    img_path_list, keys = prepare_keys_df2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # LRx2 images
    # folder_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X2_sub'
    # lmdb_path = 'datasets/DF2K/DF2K_train_LR_bicubic_X2_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # # LRx3 images
    # folder_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X3_sub'
    # lmdb_path = 'datasets/DF2K/DF2K_train_LR_bicubic_X3_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx4 images
    folder_path = 'datasets/DF2K/DF2K_train_LR_bicubic/X4_sub'
    lmdb_path = 'datasets/DF2K/DF2K_train_LR_bicubic_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_df2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
